...
<div class="container-fluid" id="container-wrapper">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between alert-light">
          <h6 class="m-0 font-weight-bold text-primary">Penyata Kutipan Tabung</h6>
          <a href="{{ route('tabung.kutipan.cetak.penyata') }}" target="_blank" class="btn btn-sm btn-secondary float-right" title="Cetak Penyata Kutipan"><i class="fas fa-print"></i> Cetak</a>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="penyata" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('tabung.kutipan.cetak.borang', $kutip->id) }}" class="btn btn-sm btn-outline-primary" title="Cetak Borang Kutipan"><i class="fas fa-print"></i> Cetak</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
